                ...
                <div className="businessDetails">
                    ...
                    <div className="busDetails-scroll">
                        <div className="side-Bar">
                            <div className="address" style={{ height: "75px" }}>
                                <img src={'https://icons.veryicon.com/png/o/miscellaneous/basic-linear-icon/address-101.png'} style={{ width: "1.3em", marginLeft: "1.1em", height: "25px" }} />
                                {businesses?.address}, {businesses?.city}, {businesses?.state}, {businesses?.zipcode}
                            </div>
                            <div className="phone-Number" style={{ height: "75px", borderTop: "1px solid lightgray", width: "350px", alignItems: "center", justifyContent: "center" }}>
                                <img src={'https://static.vecteezy.com/system/resources/previews/003/720/498/original/phone-icon-telephone-icon-symbol-for-app-and-messenger-vector.jpg'} style={{ width: "1.3em", marginLeft: "1.1em", height: "25px" }} />
                                {businesses?.phoneNumber}
                            </div>
                        </div>
                    </div>
